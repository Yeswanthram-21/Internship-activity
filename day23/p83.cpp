...
find the Area of different shapes using operator overloading.
*/
...
3. Square
Enter your choice: 2
Enter the length and breadth of the first rectangle: 2 4
Enter the length and breadth of the second rectangle: 2 4
The combined area of Rectangle and Rectangle is: 16
