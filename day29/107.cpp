...
Q1.write a c++ program for
 constructor and destructor concepts for book details using class .
...
Output:
Enter the title of the book: bookA
Enter the author of the book: AuthorA
Enter the publication year of the book: 2000
...
Destructor called for book: bookA
